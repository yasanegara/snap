...
async function migrate() {
  ...
  // Isi data awal buat paket, kalau belum ada
  await pool.query(`
    INSERT INTO plans (name, max_workspaces, max_pages_per_workspace, max_members_per_workspace, max_ai_generations)
    VALUES
      ('free', 3, 3, 2, 3),
      ('pro', 999999, 999999, 999999, 999999)
